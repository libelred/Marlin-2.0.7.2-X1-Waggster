...
- BLTouch with Stock Board using the LED-Pins acc. to the [Waggster-Mod](https://3duk.co.uk/index.php?action=downloads;sa=view;down=20). Please download the ZIP-file aswell and read the instructions!
